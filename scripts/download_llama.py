#!/usr/bin/env python3
# Run: HF_TOKEN=hf_xxxx uv run python scripts/download_llama.py
"""Download Meta-Llama-3-8B from HuggingFace.

Requires a HuggingFace token with access to gated models (https://huggingface.co/meta-llama/Meta-Llama-3-8B).
...
DEFAULT_OUTPUT = "models/Meta-Llama-3-8B"


def parse_args():
    parser = argparse.ArgumentParser(description="Download Llama-3-8B from HuggingFace")
