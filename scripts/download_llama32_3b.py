#!/usr/bin/env python3
# Run: HF_TOKEN=hf_xxxx uv run python scripts/download_llama32_3b.py
"""Download Llama-3.2-3B from HuggingFace.

Requires a HuggingFace token with access to gated models (https://huggingface.co/meta-llama/Llama-3.2-3B).
...
Usage:
    ...
    uv run python scripts/download_llama32_3b.py --output-dir /path/to/save
"""
import argparse
import os
import sys
...
DEFAULT_OUTPUT = "models/Llama-3.2-3B"


def parse_args():
    parser = argparse.ArgumentParser(description="Download Llama-3.2-3B from HuggingFace")
